...
module.exports = {
	...
	itemcatsAuthorizeGet: function(args, callback) {
		var defaultArg = {
		...
		core.callDefaultArg(defaultArg, args, callback);
	},

	// taobao.itemcats.get
	itemcatsGet: function(args, callback) {
		var defaultArg = {
	...
	itemcatsIncrementGet: function(args, callback) {
		var defaultArg = {
	...
	itempropsGet: function(args, callback) {
		var defaultArg = {
	...
	itempropvaluesGet: function(args, callback) {
		var defaultArg = {
	...
	topatsItemcatsGet: function(args, callback) {
		var defaultArg = {
